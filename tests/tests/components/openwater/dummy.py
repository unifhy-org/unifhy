...
class Dummy(OpenWaterComponent):
    ...
    _inwards_info = {
        "transfer_j": {"units": "1", "from": "surfacelayer", "method": "mean"},
        "transfer_m": {"units": "1", "from": "subsurface", "method": "mean"},
    }
    _outwards_info = {
        "transfer_l": {"units": "1", "to": ["surfacelayer"], "method": "mean"},
        "transfer_n": {
            "units": "1",
    ...
    _constants_info = {"constant_c": {"units": "1", "default_value": 3}}
    _states_info = {"state_a": {"units": "1", "divisions": (4, "constant_c")}}
    ...
    def run(
        ...
        **kwargs
        ...
        return (
            # to exchanger
            {
                "transfer_l": ancillary_b[11] * transfer_m
            ...
            # component outputs
            {
                ...
                "output_y": ancillary_b[11][0] * transfer_m
                - state_a.get_timestep(0)[..., 0, 0],
            },
        )
...
class DummyFortran(Dummy):
    ...
    _states_info = {
        "state_a": {"units": "1", "divisions": (4, "constant_c"), "order": "F"}
    }
    ...
    def initialise(
        ...
        **kwargs
        ...
        if not self.initialised_states:
            dummyfortran.initialise(state_a.get_timestep(-1), constant_c=constant_c)
...
class DummyC(Dummy):
    def initialise(
        ...
        **kwargs
        ...
        if not self.initialised_states:
            dummyc.initialise(constant_c, state_a.get_timestep(-1))
    ...
    def run(
        ...
        **kwargs
        ...
        transfer_l, transfer_n, transfer_o, output_x, output_y = dummyc.run(
            transfer_j,
            transfer_m,
            ancillary_b,
            parameter_c,
